...
<%
    ...
    String basePath = request.getScheme() + "://" +
            ...
            request.getServerPort() + path + "/resources/";
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="mainArea">
    ...
    <div class="content w1190 clearfix">
        ...
        <div class="footNum">
            <ul>
                <c:choose>
                    <c:when test="${!goodsList.isFirstPage}">
                        <li class="pre"><a href="/hnSearchWEB/search?page=1" target="_self">首页</a></li>
                    </c:when>
                </c:choose>
                <c:choose>
                    <c:when test="${goodsList.hasPreviousPage}">
                        <li class="pre"><a href="/hnSearchWEB/search?page=${goodsList.pageNum-1}"
                                           target="_self">上一页</a></li>
                    </c:when>
                </c:choose>
                <c:choose>
                    <c:when test="${goodsList.hasPreviousPage}">
                        <li class="num"><a href="/hnSearchWEB/search?page=${goodsList.pageNum-1}"
                                           target="_self">${goodsList.prePage}</a></li>
                    </c:when>
                </c:choose>
                <li class="num current"><a href="/hnSearchWEB/search?page=${goodsList.pageNum}"
                                           target="_self">${goodsList.pageNum}</a></li>
                <c:choose>
                    <c:when test="${goodsList.hasNextPage}">
                        <li class="num"><a href="/hnSearchWEB/search?page=${goodsList.pageNum+1}"
                                           target="_self">${goodsList.nextPage}</a></li>
                    </c:when>
                </c:choose>
                <c:choose>
                    <c:when test="${goodsList.hasNextPage}">
                ...
                <c:choose>
                    <c:when test="${!goodsList.isLastPage}">
                        <li class="pre"><a href="/hnSearchWEB/search?page=${goodsList.pages}" target="_self">尾页</a></li>
                    </c:when>
                </c:choose>
                <li class="ipt">
                    <input type="text">
